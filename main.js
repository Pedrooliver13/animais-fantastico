...
/***/ "./assets/js/module/accordion-list.js":
/*!********************************************!*\
  !*** ./assets/js/module/accordion-list.js ***!
  \********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initFetch; });\n/* harmony import */ var _anima_numbers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./anima-numbers.js */ \"./assets/js/module/anima-numbers.js\");\n\r\n\r\nfunction initFetch(url, target) {\r\n  function createHtml(animal) {\r\n    const div = document.createElement(\"div\");\r\n    div.classList.add(\"number__animal\");\r\n    div.innerHTML = `<h3>${animal.specie}</h3><span data-number>${animal.total}</span>`;\r\n\r\n    return div;\r\n  }\r\n\r\n  const numberGrid = document.querySelector(target); // \".numbers__grid\"\r\n  function insertHtml(animal) {\r\n    const divAnimal = createHtml(animal);\r\n    numberGrid.appendChild(divAnimal);\r\n  }\r\n\r\n  function startAnimaNumbers() {\r\n    const animaNumbers = new _anima_numbers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"[data-number]\", \".numbers\");\r\n    animaNumbers.init();\r\n  }\r\n\r\n  async function getFetch() {\r\n    try {\r\n      const results = await fetch(url);\r\n      const resultsJson = await results.json();\r\n\r\n      resultsJson.forEach((animal) => insertHtml(animal));\r\n      startAnimaNumbers();\r\n    } catch (error) {\r\n      console.log(error);\r\n    }\r\n  }\r\n\r\n  return getFetch();\r\n}\r\n\n\n//# sourceURL=webpack:///./assets/js/module/animais-fetch.js?");

/***/ }),

/***/ "./assets/js/module/bitcoin-fetch.js":
/*!*******************************************!*\
  !*** ./assets/js/module/bitcoin-fetch.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return debounce; });\nfunction debounce(callback, delay) {\r\n  let timer;\r\n  return (...args) => {\r\n    if (timer) clearTimeout(timer);\r\n    \r\n    timer = setTimeout(() => {\r\n      callback(...args);\r\n      timer = null;\r\n    }, delay);\r\n  };\r\n}\r\n\n\n//# sourceURL=webpack:///./assets/js/module/debounce.js?");

/***/ }),

/***/ "./assets/js/module/menu-dropdown.js":
/*!*******************************************!*\
  !*** ./assets/js/module/menu-dropdown.js ***!
  \*******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _module_menu_dropdown_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./module/menu-dropdown.js */ \"./assets/js/module/menu-dropdown.js\");\n/* harmony import */ var _module_menu_mobile_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/menu-mobile.js */ \"./assets/js/module/menu-mobile.js\");\n/* harmony import */ var _module_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/smooth-scroll.js */ \"./assets/js/module/smooth-scroll.js\");\n/* harmony import */ var _module_nav_tab_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./module/nav-tab.js */ \"./assets/js/module/nav-tab.js\");\n/* harmony import */ var _module_modal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./module/modal.js */ \"./assets/js/module/modal.js\");\n/* harmony import */ var _module_tooltip_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./module/tooltip.js */ \"./assets/js/module/tooltip.js\");\n/* harmony import */ var _module_work_operation_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./module/work-operation.js */ \"./assets/js/module/work-operation.js\");\n/* harmony import */ var _module_animais_fetch_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./module/animais-fetch.js */ \"./assets/js/module/animais-fetch.js\");\n/* harmony import */ var _module_bitcoin_fetch_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./module/bitcoin-fetch.js */ \"./assets/js/module/bitcoin-fetch.js\");\n/* harmony import */ var _module_accordion_list_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./module/accordion-list.js */ \"./assets/js/module/accordion-list.js\");\n/* harmony import */ var _module_anima_scroll_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./module/anima-scroll.js */ \"./assets/js/module/anima-scroll.js\");\n/* harmony import */ var _module_slide_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./module/slide.js */ \"./assets/js/module/slide.js\");\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n// import Countdown from './module/countdown.js';\r\n// import initExercicio from './module/exercicio.js';\r\n\r\nconst smoothScroll = new _module_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('[data-scroll=\"smooth\"] a[href^=\"#\"]');\r\nsmoothScroll.init();\r\n\r\nconst animaScroll = new _module_anima_scroll_js__WEBPACK_IMPORTED_MODULE_10__[\"default\"]('[data-anime=\"scroll\"]');\r\nanimaScroll.init();\r\n\r\nconst accordion = new _module_accordion_list_js__WEBPACK_IMPORTED_MODULE_9__[\"default\"]('[data-menu=\"accordion\"] dt');\r\naccordion.init();\r\n\r\nconst modal = new _module_modal_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"](\r\n  '[data-modal=\"open\"]',\r\n  '[data-modal=\"close\"]',\r\n  '[data-modal=\"container\"]'\r\n);\r\nmodal.init();\r\n\r\nconst menuDropdown = new _module_menu_dropdown_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"](\"[data-dropdown]\");\r\nmenuDropdown.init();\r\n\r\nconst menuMobile = new _module_menu_mobile_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('[data-menu=\"button\"]', '[data-menu=\"list\"]');\r\nmenuMobile.init();\r\n\r\nconst navTab = new _module_nav_tab_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"](\".js-animais li\", \"[data-tab='content'] section\");\r\nnavTab.init();\r\n\r\nconst tooltip = new _module_tooltip_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"](\"[data-tooltip]\");\r\ntooltip.init();\r\n\r\nconst workOperation = new _module_work_operation_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"](\"[data-week]\");\r\nworkOperation.init();\r\n\r\nconst bitcoin = new _module_bitcoin_fetch_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"](\"https://blockchain.info/ticker\", \"[data-bitcoin]\");\r\nbitcoin.init();\r\n\r\nconst slide = new _module_slide_js__WEBPACK_IMPORTED_MODULE_11__[\"SlideNav\"]('[data-slide=\"slide\"]', '[data-slide=\"container\"]');\r\nslide.init();\r\nslide.addControl('[data-slide=\"control\"]')\r\n\r\nObject(_module_animais_fetch_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])('./animaisapi.json', \".numbers__grid\");\r\n// const timeOfChrismas = new Countdown('25 December 2020 23:59:59 GMT-0300');\r\n\r\n// setInterval(()=> {\r\n//   console.log(timeOfChrismas.total)\r\n// }, 1000)\r\n\r\n// initExercicio();\r\n\n\n//# sourceURL=webpack:///./assets/js/scripts.js?");
...
/***/ 0:
/*!*****************************************************************!*\
  !*** multi @babel/polyfill whatwg-fetch ./assets/js/scripts.js ***!
  \*****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\n__webpack_require__(/*! whatwg-fetch */\"./node_modules/whatwg-fetch/fetch.js\");\nmodule.exports = __webpack_require__(/*! ./assets/js/scripts.js */\"./assets/js/scripts.js\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_whatwg-fetch_./assets/js/scripts.js?");
